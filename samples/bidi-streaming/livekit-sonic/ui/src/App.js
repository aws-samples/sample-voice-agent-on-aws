    ...
    return (
        <div className='livekit'>
            <div className='header'>
                <div className='title'>🎙️ Nova Sonic Voice Agent</div>
                <div className='subtitle'>Real-time speech-to-speech powered by Amazon Nova Sonic 2.0 + LiveKit</div>
                <div className='badges'>
                    <span className='badge badge-model'>Nova 2 Sonic</span>
            ...
            <div className='footer'>
                Powered by <a href="https://docs.livekit.io/agents/" target="_blank" rel="noreferrer">LiveKit Agents</a> &amp; <a href="https://aws.amazon.com/ai/generative-ai/nova/speech/" target="_blank" rel="noreferrer">Amazon Nova Sonic</a>
            </div>
        </div>
    );
}
